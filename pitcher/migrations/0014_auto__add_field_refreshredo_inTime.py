...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RefreshRedo.inTime'
        db.add_column(u'pitcher_refreshredo', 'inTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RefreshRedo.inTime'
        db.delete_column(u'pitcher_refreshredo', 'inTime')
    ...
    models = {
        ...
        u'pitcher.refreshredo': {
            ...
            'departure': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
